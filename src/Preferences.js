    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <View style={{paddingTop: 14, paddingHorizontal: 10}}>
          <Text style={{fontSize: 14, lineHeight: 30, textAlign: 'center', fontFamily: 'Roboto'}}>1 tap means you <B>like it</B>, 2 taps means you <B>love it</B>. Let us know what’s most important to you.</Text>
        </View>
