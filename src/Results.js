...
class Results extends React.Component {
  ...
  //API call - sample Url - https://productlab.carfax.ca/findmycar/multi/eventid/class/MAX/MIN/PREFERENCES/cargospace
  async getHelloW() {
  ...
  colorChange = () =>{
    ...
    for (let i = 0; i < 5; i++)
    {
      //For loop to iterate through each preference selection for each result
            ...
            <View style={styles.modalBackground} >
              <View style={styles.modalStyle}   >
                ...
                <View style={{alignItems:'center'}}>
                  ...
                  <Text style={styles.textI}>1 tap means you <B>like it</B>, 2 taps means you <B>love it</B>. Let us know what’s most important to you.</Text>
                </View>
